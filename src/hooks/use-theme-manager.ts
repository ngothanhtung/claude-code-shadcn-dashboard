...
import { themes } from "@/config/theme-data"
...
export function useThemeManager() {
  ...
  const resetTheme = React.useCallback(() => {
    ...
    const allPossibleVars = [
      ...
      "input",
      "ring",
      // Note: "radius" is intentionally NOT reset — border radius is owned by
      // the Radius customizer control (applyRadius) and globals.css, never by presets.
